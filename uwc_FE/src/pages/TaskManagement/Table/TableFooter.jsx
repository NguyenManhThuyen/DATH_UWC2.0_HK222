...
const TableFooter = () => {
    return (
        <ul className='w-full h-[80px] bg-white  rounded-b-3xl flex items-center justify-center shadow-2xl'>
            <li className='lg:w-[50px] lg:h-[50px] md:w-[45px] md:h-[45px] md:text-[20px] bg-[#018241] text-5 mx-4 text-[16px] font-bold flex items-center justify-center transition-all hover:bg-[#15F901]'>
